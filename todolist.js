...
function editStorage(id, taskCover) {
    ...
    let tear = eSInputValue.textContent;
    
    taskContainer.innerHTML = `<input id="edited-input" type="text" value="${tear}"/>\
    ...
    editStorageButton.addEventListener('click', function () {
        ...
        taskContainer.innerHTML = createdList(id, taskContainer, newEditedInput);
        isEditActive = false;
